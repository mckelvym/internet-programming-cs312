...
public class DrawCanvas extends JApplet {
    ...
    int int_1, int_2, int_3, int_4, int_5, int_6, int_7, int_8, repeat, cap_style, join_style;
    Checkbox eraser;
    Color b, c;
    ...
    public void init() {
        ...
        eraser_t = BorderFactory.createTitledBorder("Eraser");
