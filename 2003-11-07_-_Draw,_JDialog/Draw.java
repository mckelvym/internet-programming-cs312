...
public class Draw extends JFrame {
    ...
    DrawingCanvas ColorBook;

    public static void main(String[] arguements) {
        Draw executable = new Draw();
    ...
    public Draw() {
        ...
        ColorBook = new DrawingCanvas();
        this.getContentPane().setLayout(new GridLayout(1, 1));
        this.getContentPane().add(ColorBook);
...
class aDialog extends JDialog {
    ...
    String creator = "Created by Mark McKelvy using Java.";
...
class DrawingCanvas extends JApplet {
    ...
    public DrawingCanvas() {
        ...
        theMenuBar.setBorderPainted(true);
        ...
        // add action listener to the fileExit menu
        ...
        // add action listener to the helpAbout menu
        helpAbout.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (e.getSource() == helpAbout) {
                    theDialog = new aDialog();
                            /*
